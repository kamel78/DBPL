...
uses System.Types,System.UITypes, System.SysUtils, System.Math,VCL.dialogs,LargeIntegers;
...
Type
    ...
    HLint=record
        ...
        Function InversModulo(Modulo:HLint):HLint;
        Function Sqr:HLint;
        ...
        function Pow(e:longword):HLint;
        function PowMod(e, p: HLint;MgStr:Pointer=nil ): HLint;
        function IsASqrMod(p: HLint;MgStruct:Pointer): boolean;
        function Sqrt(p:HLint;MgStruct:Pointer): HLint;
        procedure SetToRandom(Limit:HLint;Seed:Word=0);
        procedure SetToRandomOnBits(nbits:Integer);
        function Absolute:HLint;
        class operator Add(const Left, Right: HLint): HLint;
        class operator Add(const Left:HLint; Right: word): HLint;
        class operator Add(const Left:Word; Right: HLint): HLint;
        class operator Subtract(const Left, Right: HLint): HLint;
        class operator Subtract(const Left: HLint;Right :Integer): HLint;
        class operator Multiply(const Left, Right: HLint): HLint;
        class operator Multiply(const Left: HLint; Right: Word): HLint;
        class operator Multiply(Left: integer; const Right: HLint): HLint;
        class operator Modulus(const Left: HLint; Right: HLint): HLint;
        class operator Divide(const Left: HLint; Right: HLint): HLint;
        class operator Implicit(const Value: string): HLint;
        class operator Implicit(const Value: Longint): HLint;
        class operator Implicit(const Value: lint): HLInt;
        class operator LeftShift(const Value: HLint; Shift: Integer): HLint;
        class operator RightShift(const Value: HLint; Shift: Integer): HLint;
        class operator Equal(const Left, Right: HLint): Boolean;
        class operator Equal(const Left:HLint; Right: DWord): Boolean;
        class operator NotEqual(const Left, Right: HLint): Boolean;
        class operator NotEqual(const Left:HLint; Right: Dword): Boolean;
        class operator GreaterThan(const Left, Right: HLint): Boolean;
        class operator GreaterThan(const Left:HLint; Right: Dword): Boolean;
        class operator GreaterThanOrEqual(const Left, Right: HLint): Boolean;
        class operator GreaterThanOrEqual(const Left:HLint; Right: Dword): Boolean;
        class operator LessThan(const Left, Right: HLint): Boolean;
        class operator LessThanOrEqual(const Left, Right: HLint): Boolean;
        class operator LessThan(const Left:HLint; Right: Dword): Boolean;
        class operator LessThanOrEqual(const Left:HLint; Right: Dword): Boolean;
        class operator Negative(const Value: HLint): HLint;
        end;

        LIntArray=Array of HLint;
        ...
        procedure _Add_Lint(t1{eax},t2{edx}:HLint;var Result{ecx}:HLint);
        Procedure _Sub_LInt(t1{eax},t2{edx}:HLint;Var result{ecx}:HLint);
        Procedure _Mul_LInt(const t1,t2:HLint;var Result:HLint);
        Procedure _Div_Mod_LInt(a,b:HLint;var Q,res:HLint);
        Procedure _Mod_LInt(a,b:HLint;var res:HLint);

        procedure _Shl_LInt(var a:HLint;count:word);
        procedure _Shr_LInt(var a:HLint;const count:word);

        Procedure _Sqr_LInt(const a:HLint;Var result:HLint);
        Procedure _Pow_LInt(a:HLint;var  Result:HLint ;p:longword);
        Procedure _Mod_Pow_LInt(a,b,modulo:HLint;var Result:HLint);
        Procedure _Mg_Mod_Pow_LInt(a,b,n:HLint;MgStruct:PtrMontgomeryStruct;var Result:HLint);
        Procedure _Sqrt_HLint(Number:HLint;Var Result:HLint);

        Function _Compare_LInt(const t1,t2:HLint):Smallint;
        function _IsNull(a:HLint):boolean;
        function _IsOne(a:HLint):boolean;
        Function _IsNeg(a:HLint):boolean;
        Function _Str_To_LInt(s:string):HLint;
        Function _LInt_To_Str(a:HLint):String;
        Function _LInt_To_Hex(a:HLint):String;
        Function ArrayToHex(a:Tbytes):wideString;
        Function HexToArray(a:widestring):Tbytes;
        Function _Hex_To_LInt(a:String):HLint;
        Function ByteArrayToLint(a:TBytes):HLint;
        Function LIntToByteArray(a:HLint):Tbytes;
        Function _Num_Of_Bits_LInt(a:HLint):word;
        Function _Num_Of_Decimals_LInt(a:HLint):Word;
        Procedure _HCopy_LInt(a:HLint;var b:HLint);
        Function _Is_BitSet_At(a:HLint;i:integer):boolean;
        procedure _Set_LInt_BitAt(var a:HLint;i:integer;value:boolean);

        Procedure _Inc_LInt(Var a:HLint;p:Dword);
        Procedure _Dec_LInt(Var a:HLint;p:Dword);
        procedure _Inv_Mod_LInt(a,modulo:HLint;var Result:HLint);

        Procedure ExtendedEuclid(a,b:HLint;Var s,t:HLint);
        Function ResolveDiopantiene(a,b,c:HLint;var x,y:HLint):Boolean;
        Procedure GetRandomLIntOnBits(Var Result:HLint;Numbits:Integer);
        Procedure GetRandomLIntLowerThan(var Result:HLint;Limit:HLint;Seed:Word=0);
        Procedure InitMontgomeryStruct(Modulo:HLint;var Struct:PtrMontgomeryStruct);
        Function IsLIntPrime(Number:HLint;Prob:Extended=0.9999):Boolean;
        function ModSquareLInt(a,modulo:HLint;Var Output:HLint;MgStruct:PtrMontgomeryStruct; test:boolean=true):boolean;
        procedure BinaryGCDLInt(a,b:HLint;var Result:HLint);
        function NAFToLInt(naf:LIntArrayForm):HLint;
        Function IsLIntOdd(a:HLint):boolean;
        procedure P_Add_Lint(const t1,t2:HLint;var result:HLint);
        procedure P_Sub_Lint(const t1,t2:HLint;var result:HLint);
        function HammingWeight(L:HLint;Negative:Boolean=False):Dword;
        function LIntToNAF(Val:HLint):LIntArrayForm;
        function LIntToIntArray(a:HLint):LIntArrayForm;
        Procedure _VHCopy_LInt(a:HLint;var b:Lint);
        Procedure _VHCopy2_LInt(a:Lint;var b:HLint);
...
{***************************************************************************************}
procedure _Add_Lint(t1{eax},t2{edx}:HLint;var result{ecx}:HLint);assembler;
{$IFDEF PUREPASCAL}
var tmp:word;
begin
...
{***************************************************************************************}
procedure _Sub_LInt(t1{eax},t2{edx}:HLint;var result{ecx}:HLint);assembler;
{$IFDEF PUREPASCAL}
var tmp:word;
begin
if t1.Data.i16[-1]<>t2.Data.i16[-1] then begin
...
Procedure _Mul_LInt(const t1,t2:HLint;var Result:HLint);assembler;
{$IFDEF PUREPASCAL}
var i,j:integer;
    val:Uint64;
    Carr1,Carr2:Dword;
...
{***************************************************************************************}
Procedure _Sqr_LInt(const a:HLint;Var result:HLint);inline;
begin
...
{***************************************************************************************}
Procedure _Div_Mod_LInt(a,b:HLint;var Q,res:HLint);inline;
{Const basediv2=2147483648;
      base=4294967296;
      base_1=4294967295;
      basearray:array [false..true] of Uint64=(base_1,base);}
...
{***************************************************************************************}
function _IsNull(a:HLint):boolean;inline;
begin
...
{***************************************************************************************}
function _IsOne(a:HLint):boolean;inline;
begin
...
while not Stop do begin
                  ...
                  _Sub_LInt(b,a,tmp);
                  tmp.data.i16[-1]:=0;
                  if _Compare_LInt(Tmp,HLint(2))=-1 then begin
                                                        _Mul_LInt(a,a,tmp);
...
Function _Is_BitSet_At(a:HLint;i:integer):boolean;
begin
result:=a.data.i32[i shr 5] and (1 shl (i and 31))<>0;
end;
...
{***************************************************************************************}
Procedure ExtendedEuclid(a,b:HLint;Var s,t:HLint);inline;
var s0,s1,t0,t1,r,q,aa,bb,tmp:HLint;
begin
_HCopy_LInt(a,aa);
_HCopy_LInt(b,bb);
S0:=1;
...
{***************************************************************************************}
procedure _Inv_Mod_LInt(a,modulo:HLint;var Result:HLint);inline;  /// the modulo is supposed to be a prime
var Q,R,tmp,_a,_mod,s0,s1:HLint;
begin
inc(numinvs);
...
{***************************************************************************************}
Function IsLIntPrime(Number:HLint;Prob:Extended=0.9999):Boolean;
Var SminusOne,Base,x,Q,minusOne:HLint;
    nbItr,Rest:Byte;
    i:integer;
    nbits:Longint;
    Prim:Boolean;
...
{***************************************************************************************}
function ModSquareLInt(a,modulo:HLint;Var Output:HLint;MgStruct:PtrMontgomeryStruct; test:boolean=true):boolean;inline;
var e1,e2,g,MinusOne,MinusOneDiv2,tmp,tmp2,tmp3:HLint;
begin
Result:=true;
if test then begin
...
if (Result.data.i16[-2] =1)and(Result.Data.i16[0]=0) then Result.Data.i16[-2]:=0;
...
{***************************************************************************************}
Function IsLIntEven(a:HLint):boolean;
begin
...
for i:=length(naf)-1 downto 0 do begin
                             if naf[i]=1 then Result:=Result+(HLint(1) shl i)
                             else if naf[i]=-1 then Result:=Result-(HLint(1) shl i);
                             end;
end;
...
{***************************************************************************************}
procedure BinaryGCDLInt(a,b:HLint;var Result:HLint);inline;
var u,v,g,t:HLint;
begin
Result.data.i32[-1]:=0;
...
{**********************************************************************************************************************}
function HLint.ToDecimalString:string;
begin
Result:=_LInt_To_Str(Self);
end;

{**********************************************************************************************************************}
function HLint.ToHexString:String;
begin
Result:=_LInt_To_Hex(Self);
end;

{**********************************************************************************************************************}
function HLint.ToNafArray: LIntArrayForm;
begin
Result:=LIntToNAF(Self);
end;

{**********************************************************************************************************************}
function HLint.ToIntArray: LIntArrayForm;
begin
...
{**********************************************************************************************************************}
Function HLint.InversModulo(Modulo:HLint):HLint;
begin
_Inv_Mod_LInt(Self,Modulo,Result);
end;

{**********************************************************************************************************************}
function HLint.IsEven: boolean;
begin
result:=IsLIntEven(self);
end;

{**********************************************************************************************************************}
function HLint.IsZero: boolean;
begin
result:=_IsNull(self);
end;

{**********************************************************************************************************************}
function HLint.IsOdd: boolean;
begin
result:=IsLIntOdd(Self);
end;

{**********************************************************************************************************************}
function HLint.IsASqrMod(p: HLint;MgStruct:Pointer): boolean; /// p is supposed to be a prime number
var g: HLint;
begin
...
{**********************************************************************************************************************}
procedure HLint.SetToRandom(Limit: HLint;Seed:Word=0);
begin
GetRandomLIntLowerThan(Self,Limit,seed);
end;

{**********************************************************************************************************************}
procedure HLint.SetToRandomOnBits(nbits: Integer);
begin
GetRandomLIntOnBits(Self,nbits);
end;

{**********************************************************************************************************************}
Function HLint.Sqr:HLint;
begin
_Sqr_LInt(Self,Result);
end;

{**********************************************************************************************************************}
function HLint.Sqrt(p:HLint;MgStruct:Pointer): HLint;
begin
...
{**********************************************************************************************************************}
class operator HLint.Subtract(const Left: HLint; Right: Integer): HLint;
var x:HLint;
begin
x.Data.i16[-2]:=1;
...
{**********************************************************************************************************************}
function HLint.BitLength:word;
begin
result:=_Num_Of_Bits_LInt(Self);
end;

{**********************************************************************************************************************}
class operator HLint.Divide(const Left: HLint; Right: HLint): HLint;
var tmp:HLint;
begin
...
{**********************************************************************************************************************}
function HLint.TestBit(i:integer):boolean;
begin
result:=_Is_BitSet_At(Self,i);
end;

{**********************************************************************************************************************}
class operator HLint.Add(const Left, Right: HLint): HLint;
begin
_Add_LInt(Left,Right,Result);
end;

{**********************************************************************************************************************}
class operator HLint.Add(const Left:HLint; Right: word): HLint;
begin
...
{**********************************************************************************************************************}
class operator HLint.Add(const Left:Word; Right: HLint): HLint;
begin
...
{**********************************************************************************************************************}
class operator HLint.Subtract(const Left, Right: HLint): HLint;
begin
_Sub_LInt(Left,Right,Result);
end;

{**********************************************************************************************************************}
class operator HLint.Multiply(const Left, Right: HLint): HLint;
begin
_Mul_LInt(Left,Right,Result);
end;

{**********************************************************************************************************************}
class operator HLint.Multiply(const Left: HLint; Right: Word): HLint;
var tmp:HLint;
begin
tmp:=0;
_Inc_LInt(tmp,Right);
...
{**********************************************************************************************************************}
class operator HLint.Multiply(Left: integer; const Right: HLint): HLint;
var tmp:HLint;
begin
tmp.Data.i16[-2]:=1;
...
{**********************************************************************************************************************}
class operator HLint.Implicit(const Value: string): HLint;
var neg:boolean;
    S:string;
begin
S:=Value;
...
{**********************************************************************************************************************}
class operator HLint.Implicit(const Value: Longint): HLint;
begin
...
class operator HLInt.Implicit(const Value: lint): HLInt;
var i:integer;
begin
Result.Data.i32[-1]:=Value.Data.i32[-1];
for i:=0 to Value.Data.i16[-2] do Result.Data.i32[i]:=Value.Data.i32[i];
end;

{**********************************************************************************************************************}
class operator HLint.Modulus(const Left: HLint; Right: HLint): HLint;
begin
_Mod_LInt(Left,Right,Result);
end;

{**********************************************************************************************************************}
class operator HLint.LeftShift(const Value: HLint; Shift: Integer): HLint;
begin
...
{**********************************************************************************************************************}
class operator HLint.RightShift(const Value: HLint; Shift: Integer): HLint;
begin
_HCopy_LInt(Value,Result);
...
{**********************************************************************************************************************}
class operator HLint.Equal(const Left, Right: HLint): Boolean;
begin
Result:=(_Compare_LInt(Left,Right)=0);
end;

{**********************************************************************************************************************}
class operator HLint.Equal(const Left:HLint; Right: DWord): Boolean;
var tmp:Dword;
begin
...
{**********************************************************************************************************************}
class operator HLint.NotEqual(const Left, Right: HLint): Boolean;
begin
Result:=(_Compare_LInt(Left,Right)<>0);
end;

{**********************************************************************************************************************}
class operator HLint.NotEqual(const Left:HLint; Right: Dword): Boolean;
begin
...
{**********************************************************************************************************************}
function HLint.Pow(e: longword): HLint;
begin
_Pow_LInt(Self,Result,e);
end;

{**********************************************************************************************************************}
function HLint.PowMod(e, p: HLint;MgStr:Pointer=nil ): HLint;
begin
...
{**********************************************************************************************************************}
class operator HLint.GreaterThan(const Left, Right: HLint): Boolean;
begin
Result:=(_Compare_LInt(Left,Right)=1);
end;

{**********************************************************************************************************************}
class operator HLint.GreaterThan(const Left:HLint; Right: Dword): Boolean;
begin
...
{**********************************************************************************************************************}
class operator HLint.GreaterThanOrEqual(const Left, Right: HLint): Boolean;
begin
Result:=(_Compare_LInt(Left,Right)>=0);
end;

{**********************************************************************************************************************}
class operator HLint.GreaterThanOrEqual(const Left:HLint; Right: Dword): Boolean;
begin
if _IsNeg(Left) then result:=false
else Result:=((Left.Data.i16[-2]=1)and(Left.Data.i32[0]>=Right))or(Left.Data.i16[-2]>1);
end;
...
{**********************************************************************************************************************}
class operator HLint.LessThan(const Left, Right: HLint): Boolean;
begin
Result:=(_Compare_LInt(Left,Right)<0);
end;

{**********************************************************************************************************************}
class operator HLint.LessThan(const Left:HLint; Right: Dword): Boolean;
begin
...
{**********************************************************************************************************************}
class operator HLint.LessThanOrEqual(const Left:HLint; Right: Dword): Boolean;
begin
...
{**********************************************************************************************************************}
class operator HLint.LessThanOrEqual(const Left, Right: HLint): Boolean;
begin
Result:=(_Compare_LInt(Left,Right)<=0);
end;

{**********************************************************************************************************************}
class operator HLint.Negative(const Value: HLint): HLint;
begin
Result:=value;
